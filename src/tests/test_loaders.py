...
def test_load_trajectory(capsys: pytest.CaptureFixture) -> None:
    load_trajectory(
        "./tests/samples/object_trajs/example_object_1", "test_load_trajectory"
    )
...
def test_object_loader_load_states() -> None:
    object_loader = ObjectLoader(
        "./tests/samples/object_trajs/example_object_1",
        "test_object_loader_load_states",
    )
...
def test_object_loader_load_up_to_state() -> None:
    object_loader = ObjectLoader(
        "./tests/samples/object_trajs/example_object_1",
        "test_object_loader_load_up_to_state",
    )
